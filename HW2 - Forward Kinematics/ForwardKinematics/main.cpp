...
int main() {
    ...
    acclaim::Motion walk(acclaim_folder / "walk.amc", std::make_unique<acclaim::Skeleton>(*skeleton));
    acclaim::Motion run(acclaim_folder / "running.amc", std::make_unique<acclaim::Skeleton>(*skeleton));
